                  ...
                  {pdfContent && (
                    <div className="glass-card p-4 rounded-lg bg-white/50 max-w-md w-full">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <label className="block text-sm mb-1.5">Question Format</label>
                          <select 
            ...
            <div className="max-w-2xl mx-auto">
              <div className="glass-card p-5 rounded-lg bg-white/50 mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:items-center p-3 bg-primary/5 rounded-md text-sm mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>Format: {questionFormat === "mcq" ? "Multiple Choice" : questionFormat === "short_answer" ? "Short Answer" : "Mixed"}</span>
                  </div>
                </div>
                
                <div className="mb-4 p-4 bg-white rounded-lg border border-gray-100">
                  <h4 className="font-medium text-primary mb-2">Sample Questions Preview:</h4>
                  <div className="space-y-3">
                    {testQuestions.slice(0, 2).map((q, idx) => (
                    ...
                    <div className="text-xs text-muted-foreground text-center">+ {testQuestions.length - 2} more questions</div>
                  </div>
                </div>
              ...
              <div className="text-sm text-muted-foreground p-4 bg-secondary/5 rounded-lg">
                ...
                <ul className="space-y-1 list-disc pl-5">
                  ...
                  <li>For short answer questions, provide concise answers</li>
                ...
                <div className="space-y-8 mb-8">
                  {testQuestions.map((question, index) => (
                    <div 
                      key={index} 
                      id={`question-${index}`}
                      className="glass-card p-4 rounded-lg bg-white/80"
                    >
